...
import kotlinx.android.synthetic.main.activity_etcpage_modify_mentee.*
...
class Etcpage_modify_mentee : AppCompatActivity()  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_etcpage_modify_mentee)
