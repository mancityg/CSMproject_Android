...
class MainpageWelcomeMentorFragment : Fragment() {
    ...
    var menteeList = arrayListOf<Mentee>(
        ...
        Mentee("채세이", "main_face_default", "성균관대학교 자과캠", "4학년", "소프트웨어학과", "24살", "여자"),
        Mentee("한지은", "main_face_default", "아주대학교", "4학년", "소프트웨어학과", "24살", "여자"),
        Mentee("고은서", "main_face_default", "성균관대학교 자과캠", "4학년", "소프트웨어학과", "23살", "여자"),
        Mentee("이상호", "main_face_default", "성균관대학교 자과캠", "4학년", "소프트웨어학과", "24살", "남자")
    )
